...
python test.py --task pt21k --fold 0 --test-test-epoch 0
python test.py --task pt21k --fold 1 --test-test-epoch 0
python test.py --task pt21k --fold 2 --test-test-epoch 0
python test.py --task pt21k --fold 3 --test-test-epoch 0
python test.py --task pt21k --fold 4 --test-test-epoch 0
