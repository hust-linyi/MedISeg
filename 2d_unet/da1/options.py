...
class Options:
    ...
    def parse(self):
        ...
        parser.add_argument('--task', type=str, default='da1', help='baseline, cutout, cutmix, cowout, cowmix, insmix')
        parser.add_argument('--fold', type=int, default=0, help='0-4, five fold cross validation')
        parser.add_argument('--name', type=str, default='res34', help='res34, res50, res101, res152')
        ...
        parser.add_argument('--test-test-epoch', type=int, default=200, help='test epoch')
        ...
        self.transform['train'] = A.Compose([
            ...
            # A.PadIfNeeded(min_height=self.train['input_size'][0], min_width=self.train['input_size'][1]),
            # A.ShiftScaleRotate(shift_limit=0.1, scale_limit=0.1, rotate_limit=45, p=0.5),
            # A.RandomCrop(height=self.train['input_size'][0], width=self.train['input_size'][1]),
