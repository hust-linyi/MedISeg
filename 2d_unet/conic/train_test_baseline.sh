...
python test.py --task baseline --fold 0  --dataset conic
python test.py --task baseline --fold 1  --dataset conic
python test.py --task baseline --fold 2  --dataset conic
python test.py --task baseline --fold 3  --dataset conic
python test.py --task baseline --fold 4  --dataset conic
