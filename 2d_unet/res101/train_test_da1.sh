...
python train.py --task da1 --fold 1 --name res101
python train.py --task da1 --fold 2 --name res101
python train.py --task da1 --fold 3 --name res101
python train.py --task da1 --fold 4 --name res101

python test.py --task da1 --fold 0 --name res101
python test.py --task da1 --fold 1 --name res101
python test.py --task da1 --fold 2 --name res101
python test.py --task da1 --fold 3 --name res101
