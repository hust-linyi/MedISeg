...
python test.py --task patch32 --fold 3 --test-gpus 0 --test-test-epoch 0 --patch-size 32
python test.py --task patch32 --fold 4 --test-gpus 0 --test-test-epoch 0 --patch-size 32
