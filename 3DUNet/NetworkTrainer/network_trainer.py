...
class NetworkTrainer:
    ...
    def set_dataloader(self):
        self.train_set = DataFolder(root_dir=self.opt.root_dir, phase='train', fold=self.opt.fold, gan_aug=self.opt.train['gan_aug'], data_transform=transforms.Compose(self.opt.transform['train']))
