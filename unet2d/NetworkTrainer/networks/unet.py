...
class OutConvy(nn.Module):
    def __init__(self, in_channels, out_channels):
        super(OutConvy, self).__init__()
        self.conv = nn.Conv2d(in_channels, out_channels, kernel_size=1)
...
class UNet(nn.Module):
    def __init__(self, n_channels, seg_classes, colour_classes, bilinear=True):
        ...
        self.colour_classes = colour_classes
        ...
        factor = 2 if bilinear else 1
        self.down41 = Down(512, 1024 // factor)
        self.up11 = Up(1024, 512 // factor, bilinear)
        self.up21 = Up(512, 256 // factor, bilinear)
        self.up31 = Up(256, 128 // factor, bilinear)
        self.up41 = Up(128, 64, bilinear)
        self.outcy = OutConvy(64, colour_classes)
